...
internal val ARRAY_METATABLE: LuaTable = LuaTable().also { it.set("__is_array", LuaValue.TRUE) }
internal val MAP_METATABLE: LuaTable   = LuaTable()

fun jsonToLua(element: JsonElement): LuaValue = when (element) {
