...
// Production PlatformService for gui_web — analogous to gui's GuiPlatformService, but not
// shared with it (gui's implementation is Compose-module-specific and off-limits).
object WebPlatformService : PlatformService {
